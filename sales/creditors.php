...
include '../set.php';
$sql = "SELECT * FROM sales where status='on credit' AND owes!=0";
            ...
            <table class="table table-striped table-bordered" id="product_table" style="margin-top: -22px;">
                ...
                while($row = mysqli_fetch_assoc($result)){
                    ...
                    <tr class="table-active">
                        ...
                        <td>
                            <a name="edit" title="Edit" style='font-size:10px; border-radius:5px;padding:4px;' href="update_creditor.php?id=<?php echo $row['reciept_no'];?>" class="btn btn-info btn-xs"><i class="fas fa-user-edit"></i></a>
