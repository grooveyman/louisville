...
<div class="sidebar">
	...
	<button id="sidebar_button" onclick="window.location.href='../sales/sales.php'"><i class="fas fa-cart-arrow-down"></i> Sales</button>
	...
	<button id="sidebar_button" onclick="window.location.href='../sales/charts.php'"><i class="fas fa-anchor"></i> Sales Chart</button>
